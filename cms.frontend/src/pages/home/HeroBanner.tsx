        ...
        <section className="relative h-[819px] min-h-[600px] w-full overflow-hidden flex items-center justify-center mb-xl">
            ...
            <div className="relative z-10 text-center px-margin max-w-3xl">
                ...
                <div className="flex flex-col sm:flex-row gap-md justify-center">
                    <Link to="/shop" className="bg-primary text-on-primary px-8 py-4 font-label-sm text-label-sm uppercase tracking-widest border border-primary text-decoration-none btn-luxury btn-primary-luxury">Shop Now</Link>
                    <Link to="/shop" className="bg-transparent text-white px-8 py-4 font-label-sm text-label-sm uppercase tracking-widest border border-white text-decoration-none btn-luxury btn-outline-light-luxury">New Collection</Link>
                </div>
            </div>
        </section>
    );
